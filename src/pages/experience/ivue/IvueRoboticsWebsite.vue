...
<client-only>
    ...
    <div class="personal-web-body personal-web-body-v3" @click="closeNavBarDropdown()">
        <InfoSector :sectorObj="IVUE_WEBSITE_INFO_SECTORS[3]" class="info-sector-v3" />
    </div>
</client-only>
</template>
...
const WEBSITE_PATH = "https://mohit-jain.com/experience/ivue/ivuerobotics";
const PAGE_TITLE = "Mohit Jain | iVue Robotics";
