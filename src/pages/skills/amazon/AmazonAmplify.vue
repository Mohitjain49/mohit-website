...
<client-only>
    ...
    <div class="personal-web-body personal-web-body-v2" @click="closeNavBarDropdown()">
        <InfoSector :sectorObj="AWS_INFO_SECTORS[1]" class="info-sector-v2" />
    </div>
</client-only>
</template>
...
const WEBSITE_PATH = "https://mohit-jain.com/skills/aws/amplify";
const PAGE_TITLE = "Mohit Jain | Amazon Web Services (AWS) | AWS Amplify";
