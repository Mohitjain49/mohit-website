...
<div class="card-container center-flex-display">
    <a :href="WORLDS_IVUE_LINK" id="wiv-nav-newCard" class="nav-newCard"
        ...
        <div class="nav-newCard-picture">
            <img :src="wiv_page" width="90%" draggable="false" />
        </div>
...
onMounted(() => {
    ...
    navCard.add("animate__animated", "animate__jackInTheBox");
    setTimeout(() => { navCard.remove("animate__animated", "animate__jackInTheBox") }, 1000);
});
