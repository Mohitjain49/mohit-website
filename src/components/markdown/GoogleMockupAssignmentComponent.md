...
* Make sure to do this **ON YOUR COMPUTER**. You will need to install [Node.js](https://nodejs.org/en) and [Visual Studio Code](https://code.visualstudio.com/), on top of learning how to configure them for developing a Vue.js app. The Vue.js website can help.  
