...
* Developed a full-stack single-page application called [Worlds iVue](https://www.worldsivue.com/), a geospatial platform that is capable of connecting to and operating advanced drones and other devices. It utilizes Amazon Web Services such as  Amazon Cognito for its user authentication services and Web APIs such as the Web Gamepad API to enable gamepad compatibility so users can operate their drone directly with a gaming controller.  
