...
.mohit-hostedDoc-contextMenu-top {
    height: 23px;
    width: calc(100% - 10px);
    display: flex;
...
.mohit-hostedDoc-contextMenu-top > h3 {
    color: var(--blue-one);
    font-size: 14px;
    font-weight: bold;
...
.mohit-hostedDoc-contextMenu-top > h3 > #mohit-document-contextMenu-pageNum {
    color: white;
    text-decoration: underline;
}

.mohit-hostedDoc-contextMenu-topOpts {
    width: fit-content;
    height: 100%;
    display: flex;
    justify-content: center;
...
.mohit-hostedDoc-contextMenu-top button {
    color: red;
    display: flex;
    justify-content: center;
    align-items: center;
...
.mohit-hostedDoc-contextMenu-top button.web-menu {
    color: var(--website-light-text);
    border-color: var(--website-light-text);
}
.mohit-hostedDoc-contextMenu-top button:hover {
    background-color: var(--dark-background);
}
.mohit-hostedDoc-contextMenu-topOpts button > svg {
    height: 9px;
}

.mohit-hostedDoc-contextMenu > button {
    color: var(--blue-one);
    ...
    width: calc(100% - 20px);
    padding: 0px 10px;
    border-top: 1px solid rgba(159, 191, 255, 0.75);
    transition: background-color 0.2s, font-size 0.2s, width 0.2s;
}

.mohit-hostedDoc-contextMenu > button.share {
    color: var(--website-light-text);
}
.mohit-hostedDoc-contextMenu > button:hover {
    background-color: var(--dark-background);
    font-size: 15px;
    width: calc(100% - 14px);
}
